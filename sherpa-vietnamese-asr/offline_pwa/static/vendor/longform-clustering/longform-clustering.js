var LongFormClusteringBundle = (() => {
  ...
  // temp/longform-libs/node_modules/umap-js/dist/utils.js
  var require_utils = __commonJS({
    "temp/longform-libs/node_modules/umap-js/dist/utils.js"(exports) {
      "use strict";
  ...
  // temp/longform-libs/node_modules/umap-js/dist/heap.js
  var require_heap = __commonJS({
    "temp/longform-libs/node_modules/umap-js/dist/heap.js"(exports) {
      "use strict";
  ...
  // temp/longform-libs/node_modules/umap-js/dist/matrix.js
  var require_matrix = __commonJS({
    "temp/longform-libs/node_modules/umap-js/dist/matrix.js"(exports) {
      "use strict";
      var __createBinding = exports && exports.__createBinding || (Object.create ? (function(o, m, k, k2) {
        if (k2 === void 0) k2 = k;
        Object.defineProperty(o, k2, { enumerable: true, get: function() {
  ...
  // temp/longform-libs/node_modules/umap-js/dist/tree.js
  var require_tree = __commonJS({
    "temp/longform-libs/node_modules/umap-js/dist/tree.js"(exports) {
      "use strict";
      var __createBinding = exports && exports.__createBinding || (Object.create ? (function(o, m, k, k2) {
        if (k2 === void 0) k2 = k;
        Object.defineProperty(o, k2, { enumerable: true, get: function() {
  ...
  // temp/longform-libs/node_modules/umap-js/dist/nn_descent.js
  var require_nn_descent = __commonJS({
    "temp/longform-libs/node_modules/umap-js/dist/nn_descent.js"(exports) {
      "use strict";
      var __createBinding = exports && exports.__createBinding || (Object.create ? (function(o, m, k, k2) {
        if (k2 === void 0) k2 = k;
        Object.defineProperty(o, k2, { enumerable: true, get: function() {
  ...
  // temp/longform-libs/node_modules/is-any-array/lib/index.js
  var require_lib = __commonJS({
    "temp/longform-libs/node_modules/is-any-array/lib/index.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
  ...
  // temp/longform-libs/node_modules/ml-matrix/matrix.js
  var require_matrix2 = __commonJS({
    "temp/longform-libs/node_modules/ml-matrix/matrix.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      var toString = Object.prototype.toString;
...
${indentData}`);
  ...
  // temp/longform-libs/node_modules/ml-levenberg-marquardt/lib/index.js
  var require_lib2 = __commonJS({
    "temp/longform-libs/node_modules/ml-levenberg-marquardt/lib/index.js"(exports, module) {
      "use strict";
  ...
  // temp/longform-libs/node_modules/umap-js/dist/umap.js
  var require_umap = __commonJS({
    "temp/longform-libs/node_modules/umap-js/dist/umap.js"(exports) {
      "use strict";
      var __createBinding = exports && exports.__createBinding || (Object.create ? (function(o, m, k, k2) {
        if (k2 === void 0) k2 = k;
        Object.defineProperty(o, k2, { enumerable: true, get: function() {
      ...
      var tree = __importStar(require_tree());
      var utils = __importStar(require_utils());
      var ml_levenberg_marquardt_1 = __importDefault(require_lib2());
  ...
  // temp/longform-libs/node_modules/clusternova/dist/hdbscan.js
  var require_hdbscan = __commonJS({
    "temp/longform-libs/node_modules/clusternova/dist/hdbscan.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      ...
      var HDBSCAN = class {
        ...
        constructor(X, mpts, distanceFunction) {
          this.X = X;
          this.allNearestNeighbors = /* @__PURE__ */ new Map();
          this.mpts = mpts;
          this.coreDistances = /* @__PURE__ */ new Map();
          this.mrg = /* @__PURE__ */ new Map();
          this.mstEdges = [];
          this.distanceFunction = distanceFunction !== null && distanceFunction !== void 0 ? distanceFunction : cosine2;
          this.idToObject = /* @__PURE__ */ new Map();
          this.X.forEach((p) => {
        ...
        _computeAllNearestNeighbors() {
          this.X.forEach((from, fromIndex) => {
            this.allNearestNeighbors.set(from.id, /* @__PURE__ */ new Map());
            this.X.forEach((to, toIndex) => {
              var _a;
              if (fromIndex !== toIndex) {
                if ((_a = this.allNearestNeighbors.get(to.id)) === null || _a === void 0 ? void 0 : _a.has(from.id)) {
                  this.allNearestNeighbors.get(from.id).set(to.id, this.allNearestNeighbors.get(to.id).get(from.id));
                } else {
        ...
        _computeCoreDistances() {
          this.allNearestNeighbors.forEach((edgesAtPoint, id) => {
            ...
            let coreDistance = distances[this.mpts - 1];
            this.coreDistances.set(id, coreDistance);
          });
        }
        _constructMRG() {
          this.X.forEach((point) => {
            this.mrg.set(point.id, /* @__PURE__ */ new Map());
          });
        ...
        _extractHDBSCANHierarchy() {
          ...
          const hierarchy = [];
          const pointToHierarchyIndex = /* @__PURE__ */ new Map();
          const currentGroups = /* @__PURE__ */ new Map();
          ...
          this.mstEdges.forEach((edge) => {
            ...
            if (newSize >= this.mpts && sizeFrom < this.mpts && sizeTo < this.mpts) {
            ...
            } else if (newSize >= this.mpts && sizeFrom >= this.mpts && sizeTo >= this.mpts) {
              hierarchy.push({
                childrenClusters: [
              ...
              if (pointToHierarchyIndex.get(newRoot) === void 0) {
                const existingIndex = (_a2 = pointToHierarchyIndex.get(rootFrom)) !== null && _a2 !== void 0 ? _a2 : pointToHierarchyIndex.get(rootTo);
          ...
          for (let i = 0; i < hierarchy.length; i++) {
            for (let j = 0; j < hierarchy[i].lambdaPs.length; j++) {
              stabilities[i] += hierarchy[i].lambdaPs[j] - ((_a = hierarchy[i].lambdaMin) !== null && _a !== void 0 ? _a : 0);
            }
          }
      ...
      function cosine2(pointA, pointB) {
        if (pointA.length !== pointB.length) {
          throw new Error("unequal dimension in input data");
        }
        let dotProduct = 0;
      ...
      var PriorityQueue = class {
        ...
        dequeue() {
          ...
          if (this._heap.length > 0 && bottomValue !== void 0) {
        ...
        _siftUp() {
          ...
          while (nodeIdx > 0 && this._comparator(this._heap[nodeIdx], this._heap[Math.floor((nodeIdx - 1) / 2)])) {
        ...
        _siftDown() {
          let nodeIdx = 0;
          while (2 * nodeIdx + 1 < this._heap.length && this._comparator(this._heap[2 * nodeIdx + 1], this._heap[nodeIdx]) || 2 * nodeIdx + 2 < this._heap.length && this._comparator(this._heap[2 * nodeIdx + 2], this._heap[nodeIdx])) {
            const smallerChildIdx = 2 * nodeIdx + 2 < this._heap.length && this._comparator(this._heap[2 * nodeIdx + 2], this._heap[2 * nodeIdx + 1]) ? 2 * nodeIdx + 2 : 2 * nodeIdx + 1;
      ...
      function findCentralElements(cluster, n, distanceFunction = cosine2) {
        if (n < 1) {
  ...
  // temp/longform-libs/node_modules/clusternova/dist/index.js
  var require_dist = __commonJS({
    "temp/longform-libs/node_modules/clusternova/dist/index.js"(exports) {
      "use strict";
      var __importDefault = exports && exports.__importDefault || function(mod) {
        return mod && mod.__esModule ? mod : { "default": mod };
      };
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.findCentralElements = exports.manhattan = exports.euclidean = exports.cosine = exports.default = void 0;
      var hdbscan_1 = require_hdbscan();
      Object.defineProperty(exports, "default", { enumerable: true, get: function() {
        return __importDefault(hdbscan_1).default;
      } });
      Object.defineProperty(exports, "cosine", { enumerable: true, get: function() {
        return hdbscan_1.cosine;
      } });
      Object.defineProperty(exports, "euclidean", { enumerable: true, get: function() {
        return hdbscan_1.euclidean;
      } });
      Object.defineProperty(exports, "manhattan", { enumerable: true, get: function() {
        return hdbscan_1.manhattan;
      } });
      Object.defineProperty(exports, "findCentralElements", { enumerable: true, get: function() {
        return hdbscan_1.findCentralElements;
      } });
    }
  });

  // temp/longform-libs/src/longform-clustering-entry.js
  var import_umap = __toESM(require_umap());
  var import_clusternova = __toESM(require_dist());
  window.LongFormClustering = {
    UMAP: import_umap.UMAP,
    cosine: import_umap.cosine,
    ClusternovaHDBSCAN: import_clusternova.default,
    clusternovaEuclidean: import_clusternova.euclidean
  };
})();
